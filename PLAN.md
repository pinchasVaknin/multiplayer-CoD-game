...
server: the split first, then the netcode, then everything else on top of it. Milestone 12 is
the scoped content backlog and Milestone 13 is the milestone in progress; both are below, in
full.
...
What stays in this file: **Milestone 12 — proposed** (the content backlog Milestone 13 carries)
